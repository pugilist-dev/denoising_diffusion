from denoising_diffusion.utils import (
    default, identity, normalize_to_neg1_1, unnormalize_to_zero_one, extract
)
from denoising_diffusion.modeling.schedulers import (
...
class DiffusionModel(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.normalize = normalize_to_neg1_1 if auto_normalize else identity
